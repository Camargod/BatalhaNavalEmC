...
void iniciaJogo(){//inicia os tabuleiros e preenche com zeros
	...
	memset(&jogador1.campo,0,100);//matriz do jogador que representa graficamente seus tiros na água ou nos barcos do adversário
}
...
int MatrizJogador(void)  //função para o usuário fazer as jogadas
{
